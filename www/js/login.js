            ...
            apiRequest('POST', '/auth/token', {
              ...
              apiRequest('GET', '/me', {}, token.access_token, function(result) {
               // window.location.replace('../templates/redirection.html');
                ...
                /*window.localStorage.setItem('user/last_name', newMe.last_name);
                window.localStorage.setItem('user/first_name', newMe.first_name);
                window.localStorage.setItem('user/email', newMe.email);*/
              });
